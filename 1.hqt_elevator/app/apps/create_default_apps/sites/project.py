...
def create_default_apps(sender, **kwargs):
    ...
    from app.apps.models import ProductCategory, Portfolio, Product, ProductFeature
    ...
    parent_pages = [
        ...
        Page(
            ...
            context='app.context_processors.products',
            url_vi='san-pham',
            name_vi='Sản Phẩm',
        ...
        Page(
            ...
            context='app.context_processors.portfolios',
            url_vi='du-an',
            name_vi='Dự Án',
            meta_title_vi='Dự Án',
            h1_vi='Dự Án Thực Tế',
        ...
        Page(
            ...
            context='app.context_processors.support',
            url_vi='ho-tro',
            name_vi='Hổ Trợ',
        ...
        Page(
            ...
            context='app.context_processors.articles',
            url_vi='tin-tuc',
            name_vi='Tin Tức',
    ...
    child_pages = [
        Page(
            ...
            context='app.context_processors.category',
            url_vi='danh-muc/(?P<slug>[-\w]+)',
        ...
        Page(
            ...
            context='app.context_processors.product',
            url_vi='san-pham/(?P<slug>[-\w]+)',
            name_vi='Sản Phẩm',
        ...
        Page(
            ...
            context='app.context_processors.portfolio',
            url_vi='du-an/(?P<slug>[-\w]+)',
            name_vi='Dự Án',
        ...
        Page(
            ...
            context='app.context_processors.article',
            url_vi='tin-tuc/(?P<slug>[-\w]+)',
            name_vi='Tin Tức',
    ...
    ProductCategory.objects.bulk_create([
        ProductCategory(
            ...
            description="Toàn cảnh sang trọng, tạo không gian mở",
            is_active=True,
        ),
        ProductCategory(
            code="TMCC",
            ...
            description="Tối ưu hoá tính tiết kiệm không gian",
            is_active=True,
        ),
        ProductCategory(
            code="TMTH",
            ...
            description="Công nghệ tối ưu, tiết kiệm năng lượng",
            is_active=True,
        ),
        ProductCategory(
        code="TMTL",
