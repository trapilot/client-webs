...
def create_default_apps(sender, **kwargs):
    ...
    parent_pages = [
        Page(
            ...
            context='project.context_processors.home',
            url_vi='trang-chu',
            name_vi='Trang Chủ',
        ...
        Page(
            ...
            context='project.context_processors.products',
            url_vi='san-pham',
            name_vi='Sản Phẩm',
        ...
        Page(
            ...
            context='project.context_processors.portfolios',
            url_vi='du-an',
            name_vi='Dự Án',
            meta_title_vi='Dự Án',
            h1_vi='Dự Án Thực Tế',
        ...
        Page(
            ...
            context='project.context_processors.support',
            url_vi='ho-tro',
            name_vi='Hổ Trợ',
        ...
        Page(
            ...
            context='project.context_processors.articles',
            url_vi='tin-tuc',
            name_vi='Tin Tức',
    ...
    child_pages = [
        Page(
            ...
            context='project.context_processors.category',
        ...
        Page(
            ...
            context='project.context_processors.product',
        ...
        Page(
            ...
            context='project.context_processors.portfolio',
        ...
        Page(
            ...
            context='project.context_processors.article',
