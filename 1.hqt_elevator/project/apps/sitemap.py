...
def extension(project, context):
    lang = get_language()
    
    def build_sitemap(project, page, context, **kwargs):
        sm = UrlSitemap()
        sm.url = build_page_url(project, page, context.language, False, **kwargs)
        ...
        if page.is_internal:
            if page.code == 'product':
                ...
                for article in articles:
                    ...
                    pages.append(build_sitemap(project, page, context, slug=article.slug))
                ...
                for portfolio in portfolios:
                    ...
                    pages.append(build_sitemap(project, page, context, slug=portfolio.slug))
