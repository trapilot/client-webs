...
-- 1. RENAME COLUMN
ALTER TABLE web_engine_site
RENAME COLUMN extra_robots TO robots_extra;

-- 2. DROP FIELD
ALTER TABLE web_engine_marketingclaim
DROP COLUMN icon;
...
ALTER TABLE web_engine_highlight
ADD COLUMN icon_img VARCHAR(255) NULL;

ALTER TABLE web_engine_socialnetwork
ADD COLUMN icon_img VARCHAR(255) NULL;

ALTER TABLE web_engine_marketingclaim
ADD COLUMN label_vi VARCHAR(255) NULL,
ADD COLUMN icon_code VARCHAR(30) NULL,
ADD COLUMN icon_img VARCHAR(255) NULL,
ADD COLUMN icon_svg TEXT NULL,
ADD COLUMN icon_name VARCHAR(150) NULL,
ADD COLUMN sublabel_vi VARCHAR(255) NULL;
...
ALTER TABLE web_engine_license
MODIFY COLUMN logo VARCHAR(255) NULL;

ALTER TABLE web_engine_marketingclaim
MODIFY COLUMN is_active TINYINT(1) NULL DEFAULT 1;

ALTER TABLE web_engine_page
...
MODIFY COLUMN mode INT NOT NULL DEFAULT 0;

-- 5. DELETE TABLE
DROP TABLE IF EXISTS web_engine_topfeature;